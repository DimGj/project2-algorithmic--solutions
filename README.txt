...
II ) Όσον αφορά την Search on Graph ισχύουν τα παρακάτω βήματα:
		...
		3) Με αυτο το τρόπο λαμβάνουμε εναν MRNG γράφο (κατευθυνόμενο πάντα) , ο οποιός θα χρησιμοποιηθεί ως ευρετήριο στην generic search on graph (απο το uploaded paper του project 2) 
